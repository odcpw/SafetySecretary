...
test("Drawer renders side anchored dialog semantics when open", () => {
	...
	assert.match(html, /Hazard details/);
});
...
test("Drawer traps focus, closes on Escape, and returns focus", async () => {
	...
	const firstAction = buttonByText(buttons, "Save");
	const lastAction = buttonByText(buttons, "Close");
...
test("overlays fixture includes drawer semantics", () => {
